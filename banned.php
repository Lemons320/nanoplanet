...
<article>
    <h1>Well, You've been banned ".$user->username."!</h1>
    <div>
        <p>reason: ".$banInfo->reason."</p>
        <p>You will been unbanned on ".date('m/d/y', $banInfo->ban_time).", until then, wait until you are unbanned. &mdash; <a href='logout.php?logout'>logout</a></p>
    </div>
</article>
";
?>